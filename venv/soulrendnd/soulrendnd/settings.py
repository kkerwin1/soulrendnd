...
# development mode
if "kris" in os.path.join(BASE_DIR):
	DEBUG = True
...
ALLOWED_HOSTS = ['localhost', '192.168.1.19', '192.168.1.14', 'soulrendnd.servegame.com', '127.0.0.1', '192.168.1.*']
...
WSGI_APPLICATION = 'soulrendnd.wsgi.application'
